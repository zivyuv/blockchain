    ...
    return (
        <div className="card border-info bg-dark mb-4"
            ...
            <div className="card-header bg-dark border-info">
                <h5 className="card-title text-light bg-dark"style={{textAlign: "center"}}>{header}
            ...
            <div className="card-body text-info">
                <h5 className="card-title text-light bg-dark"style={{textAlign: "center"}}>Hi there! I am offering:</h5>
                <p className="card-text text-light"style={{textAlign: "center"}}>{content}</p>
                {/* //if soldcount = 0, should say "Be the first to recieve this service " */}
                <p className="card-text"style={{textAlign: "center"}}> This service was given xxENTER SOLDCOUNTxx times. </p>
            </div>
            {/* <ButtonGroup aria-label="Basic example">
                ...
                <button className="btn btn-info" style={{marginBottom: "1rem", marginLeft: "3rem", marginRight: "3rem"}}>Buy for {price}$</button>
